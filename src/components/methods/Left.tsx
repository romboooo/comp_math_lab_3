...
export default function LeftRectangleMethod({
  a,
  b,
  func,
  integralId,
  ...
  return (
    <div className="method-result">
      <h2>Метод левых прямоугольников:</h2>
      <h3>
        <InlineMath
          math={`\\ ${
      ...
      {latest && (
        <div className="calculation-steps">
          ...
          <div>
            <InlineMath
              math={`\\sum_{i=0}^{n-1}y_i=${formatNumber(latest.sum, 4)}`}
            />
          </div>
          <div>
            <InlineMath
          ...
          <InlineMath
            math={`h \\cdot \\sum_{i=0}^{n-1} y_i = ${formatValue(
              (b - a) / latest.n,
              4
